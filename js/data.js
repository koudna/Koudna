/* ==========================================================
   ...
   ========================================================== */
    ...
    import { dataLessons } from "./lessons-datascience.js";
...
<span class="fn">cd</span> Documents` }
        ...
        data: {
            ...
            hours: { ar: "20 ساعة", en: "20 hours" },
            description: { ar: 'تعلم تحليل البيانات من الصفر: بايثون للبيانات، NumPy، Pandas، التنظيف، التصور، الإحصاء التطبيقي، ومقدمة تعلّم الآلة — بمشاريع عملية.', en: 'Learn data analysis from scratch: Python for data, NumPy, Pandas, cleaning, visualization, applied statistics, and an intro to machine learning — with hands-on projects.' },
            lessons: []
        },
        computer: {
            comingSoon: true,
    ...
    catalog.data.lessons = dataLessons;
